...
ft_path = '/data/u_bruera_software/word_vectors/it/conceptnet_it.pkl'
...
### vectors
with open(os.path.join(vectors_f, 'conceptnet_verbnoun.tsv'), 'w') as o:
    ...
    for phrase_i, phrase in enumerate(stimuli):
        ...
        o.write('\n')
### matrix
with open(os.path.join(matrix_f, 'conceptnet_verbnoun.tsv'), 'w') as o:
